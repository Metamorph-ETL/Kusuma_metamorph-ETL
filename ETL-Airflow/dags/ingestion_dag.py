...
from tasks.supplier_performance_task import m_load_suppliers_perfomance
...
def etl_process():
   ...
   supplier_perf_task = m_load_suppliers_perfomance()


   supplier_task >> product_task >> customer_task >> sales_task >> supplier_perf_task
